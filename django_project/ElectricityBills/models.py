...
class MeterRequestForm(forms.ModelForm):
    class Meta:
        model = MeterRequest
        fields = ['national_ID', 'name', 'meter_address', 'phone_num', 'address', 'block_num', 'phone_num2', 'approvale_authority_name', 'approvale_authority', 'applicant', 'tax_num', 'Governorate', 'Enterprise']
